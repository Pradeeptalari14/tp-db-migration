# 🔧 Troubleshooting Guide — Database Migration Studio
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-db-migration/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/db-migration/)
