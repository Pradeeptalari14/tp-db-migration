...
Thank you for your interest in improving the **Database Migration Studio** studio resources! 🎉
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/tp-db-migration.git
...
Generated configurations come from the **[Database Migration Studio Studio](https://pradeeptalari14.github.io/portfolio/tools/db-migration/)**.
